...
@pytest.mark.parametrize(
    ...
    (
        ...
        {
            "name": "and",
            "conditions": [{"and": ["base:foo", "base:baz"]}],
            "actions": {},
        },
        {"name": "or", "conditions": [{"or": ["base:foo", "base:baz"]}], "actions": {}},
        {
            "name": "and,or",
            "conditions": [{"and": ["label=foo", {"or": ["base:foo", "base:baz"]}]}],
            "actions": {},
        },
        {
            "name": "or,and",
            "conditions": [{"or": ["label=foo", {"and": ["base:foo", "base:baz"]}]}],
            "actions": {},
        },
    ),
)
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            "maximun number of nested and/or reached",
        ),
        (
            {
                "name": "nested checks",
