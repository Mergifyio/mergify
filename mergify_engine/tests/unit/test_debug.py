...
@pytest.mark.parametrize(
    ...
    [
        ...
        "https://github.com/mergifyio/mergify-engine/pull/123#",
        "https://github.com/mergifyio/mergify-engine/pull/123#",
        "https://github.com/mergifyio/mergify-engine/pull/123#123",
        "https://github.com/mergifyio/mergify-engine/pull/123?foo=123",
        "https://github.com/mergifyio/mergify-engine/pull/123?foo=123&bar=123",
...
def test_url_parser_with_pr_ok(url: str) -> None:
    assert debug._url_parser(url) == ("mergifyio", "mergify-engine", "123")
