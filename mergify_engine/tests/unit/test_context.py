...
def test_get_merge_commit_message():
    assert (
        context.Context._get_merge_commit_message(
            """Hello world
...
my body"""
        ...
        == {"commit_title": "my title", "commit_message": "my body"}
    )
    assert (
        context.Context._get_merge_commit_message(
            """Hello world
...
my body"""  # noqa:W293
        ...
        == {
            ...
            "commit_message": "WATCHOUT ^^^ there is empty spaces above for testing ^^^^\nmy body",
        }
    )
