...
review_approved_by = "review-approved-by" + _match_with_operator(github_login)
review_dismissed_by = (
    "review-dismissed-by" + _match_with_operator(github_login)
)
review_changes_requested_by = (
    "review-changes-requested-by" + _match_with_operator(github_login)
)
review_commented_by = (
    "review-commented-by" + _match_with_operator(github_login)
)
